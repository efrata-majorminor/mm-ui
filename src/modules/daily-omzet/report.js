...
export class Report {
    ...
    async activate() {
       ...
       // this.totalQuantity = this.standaloneCount + this.consignmentCount + this.onlineCount + this.generalSalesCount+ this.vvipCount;
        ...
        // this.standalone = (this.getArray(apiResult.DataList.StandAlone));        

        // this.consignment =(this.getArray(apiResult.DataList.Konsinyasi));
        // this.online = (this.getArray(apiResult.DataList.Online));
        // var dimGeneralSales = (this.getArray(apiResult.DataList.WholeSale));
        var arrGeneralSales = [];
