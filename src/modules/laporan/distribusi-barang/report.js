            ...
            this.data = result.data.map(item => {
                var details = item.spkDocuments.map(packinglist => {
                    ...
                    return {
                        ...
                        transaction: (packinglist.packingList.indexOf("MM-KB/PLB") != -1 ? 0 : 1),
                        transactionName: (packinglist.packingList.indexOf("MM-KB/PLB") != -1 ? "Pengiriman Barang Baru" : "Pengiriman Barang Retur"),
